...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "DHS Harmonization Pipeline",
    Description = "This package documents the pipeline used to merge and harmonize the DHS data for the lab.",
    `Authors@R` = c(
      person("Tinashe", "Tapera", email = "ttapera@hsph.harvard.edu", role = c("aut", "cre")),
      person("Christopher", "Golden", email = "golden@hsph.harvard.edu", role = c("cph"))
    )
  )
)
