...
#TODO what is the relatinoship between our healthsheds and the survey locations
...
I believe that each of these points is the location of a
survey cluster.

So we can keep the reading function as is, there's not
much else to add.  
...
That being known, we can set one function to read all of our
different types of DHS data and merge them:
